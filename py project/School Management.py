...
mydb=mysql.connector.connect(host="Localhost",user="root",#passwd="0045",
                         passwd="0045",database='marklist')
...
def get_12():
    ...
    def get_bio():
        ...
        '''
        import mysql.connector
        mydb=mysql.connector.connect(host="Localhost",user="root",passwd="0045",database='marklist')
        mycursor=mydb.cursor()
        '''
        roll=Label(s,text="Exam Roll Number \t:",bg="pink",fg="black")
        roll.grid(row=1,column=0)
